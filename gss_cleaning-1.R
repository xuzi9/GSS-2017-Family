...
raw_data <- read_csv("A:/(2) Zikun 2020-2021 classes/STA304/PS3/AAsLlxNK.csv")
dict <- read_lines("A:/(2) Zikun 2020-2021 classes/STA304/PS3/gss_dict-1.txt", skip = 18) # skip is because of preamble content
# Now we need the labels because these are the actual responses that we need
labels_raw <- read_file("A:/(2) Zikun 2020-2021 classes/STA304/PS3/gss_labels-1.txt")
